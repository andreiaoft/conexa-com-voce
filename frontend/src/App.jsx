...
function App() {
  ...
  const handleStartNewPlan = useCallback(() => {
    // limpa só o resultado atual da direita
    setPlan(null);
    setPatientId("");
    setCasesError(null);
  }, []);
      ...
      <main className="mx-auto max-w-7xl px-4 pb-8 pt-[80px]">
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          {plan ? (
            ...
            <div className="flex min-h-[400px] flex-col items-center justify-center rounded-xl border-2 border-dashed border-slate-300 bg-white p-8 text-slate-400">
              <svg
              ...
              <p className="mt-2 text-center text-sm">
                Envie um resumo clínico ao lado para gerar o plano do paciente.
              </p>
            </div>
          )}
        </div>
